...
IO.setmode (IO.BOARD)       # programming the GPIO by BOARD pin numbers, GPIO21 is called as PIN40 If you remember we talked about IO.BOARD and IO.BCM
...
IO.setmode (IO.BOARD)
IO.setup(40,IO.OUT)
IO.output(40,1)		#Setting OUTPUT HIGH
time.sleep(1)
IO.cleanup()
time.sleep(1)
